export const en = {
    ...
    executionModeLocal: 'Local API (Ultra)',
    executionModeDirect: 'AI Studio Direct (Lite)',
    executionModeSelectorTooltip: 'Switch Execution Engine Mode (Auto / Local API / AI Studio Direct)',
