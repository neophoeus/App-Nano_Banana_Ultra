export const en = {
    ...
    rateLimitModalDesc:
        'The requests-per-minute quota (IPM / RPM 429) has been reached. The system has automatically paused and will retry once the cooldown expires.',
    ...
    toolMagnetSnap: 'Magnetic Snap (45°)',
    btnRotateLeft: 'Rotate Left 90°',
    modeRevolve: 'Revolve',
    revolveYaw: 'Yaw',
    revolvePitch: 'Pitch',
    revolveResetAngle: 'Reset Angle',
    revolvePresetFront: 'Front (0°)',
    revolvePresetLeft: 'Left (-30°)',
    revolvePresetRight: 'Right (+30°)',
    revolvePresetHigh: 'High (+20°)',
    revolvePresetLow: 'Low (-20°)',
    revolveToolOrbit: '3D Orbit (Rotate)',
    revolveToolPan: 'Pan (Shift View)',
    revolveZoom: 'Zoom',
    revolvePan: 'Pan',
