export const fr = {
    ...
    promptThinkingLevelLowTooltip: '⚡ Low: Réponse ultra-rapide, consommation minimale de tokens',
    promptThinkingLevelMediumTooltip: '🧠 Med: Raisonnement standard, créativité équilibrée',
    promptThinkingLevelHighTooltip: '🔬 High: Analyse détaillée approfondie',
