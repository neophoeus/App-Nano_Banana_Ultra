export const fr = {
    ...
    rateLimitModalDesc:
        'Le quota par minute (IPM / RPM 429) a été atteint. Le système a été mis en pause et réessaiera à la fin du délai.',
    ...
    toolMagnetSnap: 'Alignement magnétique (45°)',
    btnRotateLeft: 'Pivoter de 90° vers la gauche',
    modeRevolve: 'Révolution',
    revolveYaw: 'Horizontal (Yaw)',
    revolvePitch: 'Inclinaison (Pitch)',
    revolveResetAngle: 'Réinitialiser l’angle',
    revolvePresetFront: 'Face (0°)',
    revolvePresetLeft: 'Gauche (-30°)',
    revolvePresetRight: 'Droite (+30°)',
    revolvePresetHigh: 'Plongée (+20°)',
    revolvePresetLow: 'Contre-plongée (-20°)',
    revolveToolOrbit: 'Orbite 3D',
    revolveToolPan: 'Panoramique (Pan)',
    revolveZoom: 'Zoom',
    revolvePan: 'Panoramique',
