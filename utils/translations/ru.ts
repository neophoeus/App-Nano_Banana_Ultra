export const ru = {
    ...
    executionModeLocal: 'Локальный API (Ultra)',
    executionModeDirect: 'AI Studio напрямую (Lite)',
    executionModeSelectorTooltip: 'Переключение режима движка (Авто / Локальный API / AI Studio напрямую)',
