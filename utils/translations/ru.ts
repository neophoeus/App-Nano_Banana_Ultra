export const ru = {
    ...
    promptThinkingLevelLowTooltip: '⚡ Low: Быстрый ответ, минимальный расход токенов',
    promptThinkingLevelMediumTooltip: '🧠 Med: Стандартное рассуждение, баланс креативности',
    promptThinkingLevelHighTooltip: '🔬 High: Глубокий анализ деталей',
