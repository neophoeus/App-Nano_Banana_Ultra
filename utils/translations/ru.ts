export const ru = {
    ...
    rateLimitModalDesc:
        'Превышен лимит запросов в минуту (IPM / RPM 429). Система автоматически приостановила запросы и повторит попытку после кулдауна.',
    ...
    toolRotation: 'Поворот',
    toolMagnetSnap: 'Магнитное прилипание (45°)',
    btnRotateLeft: 'Повернуть на 90° влево',
    modeRevolve: 'Круговой обзор',
    revolveYaw: 'По горизонтали (Yaw)',
    revolvePitch: 'Наклон (Pitch)',
    revolveResetAngle: 'Сбросить угол',
    revolvePresetFront: 'Спереди (0°)',
    revolvePresetLeft: 'Влево (-30°)',
    revolvePresetRight: 'Вправо (+30°)',
    revolvePresetHigh: 'Сверху (+20°)',
    revolvePresetLow: 'Снизу (-20°)',
    revolveToolOrbit: '3D вращение',
    revolveToolPan: 'Панорамирование',
    revolveZoom: 'Масштаб',
    revolvePan: 'Панорамирование',
