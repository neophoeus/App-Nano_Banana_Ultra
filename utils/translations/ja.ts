export const ja = {
    ...
    rateLimitModalDesc:
        '1分あたりのリクエスト頻度（IPM / RPM 429）上限に達しました。保護のため自動一時停止しており、クールダウン完了後に自動再試行します。',
    ...
    modeOutpaint: 'リフレーム',
    toolRotation: '回転',
    toolMagnetSnap: 'マグネット吸着 (45°)',
    btnRotateLeft: '左に90度回転',
    modeRevolve: 'リボルブ',
    revolveYaw: '水平アングル (Yaw)',
    revolvePitch: '上下アングル (Pitch)',
    revolveResetAngle: 'アングルリセット',
    revolvePresetFront: '正面 (0°)',
    revolvePresetLeft: '左 (-30°)',
    revolvePresetRight: '右 (+30°)',
    revolvePresetHigh: '俯瞰 (+20°)',
    revolvePresetLow: '見上げ (-20°)',
    revolveToolOrbit: '3D回転 (Orbit)',
    revolveToolPan: 'パン / 移動 (Pan)',
    revolveZoom: 'ズーム (Zoom)',
    revolvePan: 'パン',
