export const es = {
    ...
    promptThinkingLevelLowTooltip: '⚡ Low: Respuesta ultrarrápida, menor coste de tokens',
    promptThinkingLevelMediumTooltip: '🧠 Med: Razonamiento estándar, creatividad equilibrada',
    promptThinkingLevelHighTooltip: '🔬 High: Análisis forense profundo y detallado',
