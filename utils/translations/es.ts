export const es = {
    ...
    executionModeLocal: 'API local (Ultra)',
    executionModeDirect: 'AI Studio directo (Lite)',
    executionModeSelectorTooltip: 'Cambiar modo de motor de ejecución (Automático / API local / AI Studio directo)',
