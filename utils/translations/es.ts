export const es = {
    ...
    rateLimitModalDesc:
        'Se ha alcanzado el límite por minuto (IPM / RPM 429). El sistema se ha pausado automáticamente y reintentará tras el enfriamiento.',
    ...
    toolRotation: 'Rotación',
    toolMagnetSnap: 'Ajuste magnético (45°)',
    btnRotateLeft: 'Girar 90° a la izquierda',
    modeRevolve: 'Revolución',
    revolveYaw: 'Horizontal (Yaw)',
    revolvePitch: 'Inclinación (Pitch)',
    revolveResetAngle: 'Restablecer ángulo',
    revolvePresetFront: 'Frente (0°)',
    revolvePresetLeft: 'Izquierda (-30°)',
    revolvePresetRight: 'Derecha (+30°)',
    revolvePresetHigh: 'Picado (+20°)',
    revolvePresetLow: 'Contrapicado (-20°)',
    revolveToolOrbit: 'Órbita 3D',
    revolveToolPan: 'Desplazar (Pan)',
    revolveZoom: 'Zoom',
    revolvePan: 'Desplazar',
