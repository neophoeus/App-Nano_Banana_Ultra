export const de = {
    ...
    executionModeLocal: 'Lokale API (Ultra)',
    executionModeDirect: 'AI Studio direkt (Lite)',
    executionModeSelectorTooltip: 'Engine-Modus umschalten (Automatisch / Lokale API / AI Studio direkt)',
