export const de = {
    ...
    rateLimitModalDesc:
        'Das Kontingent pro Minute (IPM / RPM 429) wurde erreicht. Das System hat automatisch pausiert und versucht es nach der Abkühlzeit erneut.',
    ...
    toolRotation: 'Drehung',
    toolMagnetSnap: 'Magnetische Einrastung (45°)',
    btnRotateLeft: '90° nach links drehen',
    modeRevolve: 'Umlauf',
    revolveYaw: 'Horizontal (Yaw)',
    revolvePitch: 'Neigung (Pitch)',
    revolveResetAngle: 'Winkel zurücksetzen',
    revolvePresetFront: 'Vorne (0°)',
    revolvePresetLeft: 'Links (-30°)',
    revolvePresetRight: 'Rechts (+30°)',
    revolvePresetHigh: 'Oben (+20°)',
    revolvePresetLow: 'Unten (-20°)',
    revolveToolOrbit: '3D-Orbit',
    revolveToolPan: 'Schwenken (Pan)',
    revolveZoom: 'Zoom',
    revolvePan: 'Schwenken',
