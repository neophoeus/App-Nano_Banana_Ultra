export const de = {
    ...
    promptThinkingLevelLowTooltip: '⚡ Low: Ultraschnelle Antwort, minimaler Token-Verbrauch',
    promptThinkingLevelMediumTooltip: '🧠 Med: Standard-Schlussfolgerung, ausgewogene Kreativität',
    promptThinkingLevelHighTooltip: '🔬 High: Tiefgehende Detailanalyse',
