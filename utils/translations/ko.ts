export const ko = {
    ...
    promptThinkingLevelLowTooltip: '⚡ Low: 빠른 응답 속도 및 최소 토큰 소모',
    promptThinkingLevelMediumTooltip: '🧠 Med: 표준 추론 및 균형 잡힌 창의성',
    promptThinkingLevelHighTooltip: '🔬 High: 심층 디테일 분석 및 장문 추론',
