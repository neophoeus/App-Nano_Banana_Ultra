export const ko = {
    ...
    rateLimitModalDesc:
        '분당 요청 빈도(IPM / RPM 429) 한도에 도달했습니다. 보호를 위해 자동 일시 중지되었으며, 대기 시간이 끝나면 자동으로 재시도합니다.',
    ...
    modeOutpaint: '리프레임',
    toolRotation: '회전',
    toolMagnetSnap: '마그넷 스냅 (45°)',
    btnRotateLeft: '왼쪽으로 90도 회전',
    modeRevolve: '리볼브',
    revolveYaw: '수평 회전 (Yaw)',
    revolvePitch: '상하 각도 (Pitch)',
    revolveResetAngle: '각도 초기화',
    revolvePresetFront: '정면 (0°)',
    revolvePresetLeft: '좌측 (-30°)',
    revolvePresetRight: '우측 (+30°)',
    revolvePresetHigh: '하이앵글 (+20°)',
    revolvePresetLow: '로우앵글 (-20°)',
    revolveToolOrbit: '3D 회전 (Orbit)',
    revolveToolPan: '팬 / 이동 (Pan)',
    revolveZoom: '확대/축소 (Zoom)',
    revolvePan: '팬',
