...
describe('savedImageFilename helpers', () => {
    ...
    it('builds deterministic saved image stems from model, timestamp, slot, and workflow', () => {
        ...
        ).toBe('gemini-3.1-flash-image_20260506-143522_03-a7c9f2e1_ref2img');
    });
    ...
    it('derives result part stems from the saved primary filename when available', () => {
        expect(
            buildResultPartFilenameStem({
                ...
                sequence: 7,
                sourceSavedFilename: 'gemini-3-pro-image_20260506-143522_01-fedcba98_txt2img.jpg',
            }),
        ).toBe('gemini-3-pro-image_20260506-143522_01-fedcba98_txt2img-part-07');
    });
});
